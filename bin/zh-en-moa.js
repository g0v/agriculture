...
var fs, path, find, LineInputStream, runningAsScript, parse, ref$, files, i$, len$, filepath, slice$ = [].slice;
fs = require('fs');
path = require('path');
...
parse = function(filepath, done){
  ...
  x$.on('end', function(){
    ...
    return typeof done == 'function' ? done(result) : void 8;
    function fn$(it){
